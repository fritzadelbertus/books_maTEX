...
\input{figures/uts/2023_5_1.fig.tex}
...
\item Diberikan fungsi $\ds f(x) = \frac{\sqrt{5}\abs{x}}{x}$ dan $g(x) = -\sqrt{9-x^{2}}$.
    ...
    \input{figures/uts/2023_1_1.fig.tex}
...
\begin{center}\line(1,0){150}\end{center}
    ...
    \input{figures/uts/2023_1_2.fig.tex}
...
\item Diberikan fungsi $f(x) = \floor{x}^2$.
    ...
    \input{figures/uts/2023_2_1.fig.tex}
    \input{figures/uts/2023_2_2.fig.tex}
...
\begin{center}\line(1,0){150}\end{center}
    ...
    \input{figures/uts/2023_4_1.fig.tex}
...
\input{figures/uts/2023_5_2.fig.tex}
