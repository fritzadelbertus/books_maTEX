...
\begin{align*}
    ...
    &\text{faktorisasi}\\
\end{align*}
Titik kritis pertidaksamaan ini adalah $x=-2$, $x=-1$, dan $x=0$.
\begin{center}
    \begin{tikzpicture}
        \draw[stealth-stealth] (-5,0) node[below]{$-\infty$}--(5,0) node[below]{$\infty$};
        \draw (-5,1) --(-2,1);
...
\begin{enumerate}[label={\alph*}.]
    ...
    \begin{enumerate}[label={\arabic*})]
        ...
        \begin{align*}
            ...
            &=\bracket*{\drv{x}{4x}y+4x\drv{x}{y}}(x^{2}+1)+8x^{2}y
            &\text{aturan perkalian}\\
            &=(4y+4xy')(x^{2}+1)+8x^{2}y
        \end{align*}
        \item
...
\begin{center}
    ...
    \begin{enumerate}[label={\alph*}.]
        ...
        \begin{align*}
            ...
            &=\sqrt{\frac{b}{a}}\sqrt{a-\bracket*{\sqrt{\frac{a}{2}}}^2}\\
            &=\sqrt{\frac{b}{a}}\sqrt{a-\frac{a}{2}}\\
            &=\sqrt{\frac{b}{a}\bracket*{a-\frac{a}{2}}}\\
            &=\sqrt{\frac{b}{2}}
        \end{align*}
